...
Last updated: 2026-08-12 (222 tests green; gated verifier review completed — threshold-complement inverses now approvable, verified to change no current verdict; CPI's remaining gaps are venue-text only, and a Kalshi terminal-fallback revision would make the settled monthly tail pair the first trusted label automatically)
