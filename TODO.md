...
- [ ] Fifth charter (market making, paper-only replay): signed 2026-09-08 (#32); instrument frozen 2026-09-15 at `383d609` (#65); **Arm B done 2026-09-15: FAIL** (352 games, net −$4,492.52, 25.6% of markets positive, −1.98¢/contract; artifact `docs/proof/making-result-armB.json.gz`; the §11.3 hold was broken by accident and is recorded in the charter); Arm A on 2026-09-17, expected INCONCLUSIVE on 3 of 4 markets, then widened once to settlements by 2026-10-28 (Fed books retained, #64); write both results into the charter
