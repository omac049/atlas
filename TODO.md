...
- [ ] Fee Verified affiliate programs: **Shopify/Impact live 2026-09-09**; **Intuit Product Referrals approved 2026-09-10** (QuickBooks Payments page built for it; owner: copy the referral link from the Intuit Partner Portal and add a payout bank account); Wise/Partnerize requested (owner: verify the Partnerize email, and fix the account's website from verifiedfeeds.com to verifiedfees.com); still to apply: Printful, Printify, Square/Impact, Vendoo/Awin. Placement rule: `feeverified/site.py` PARTNERS
