...
Last updated: 2026-08-24 (release-window keep-awake agent shipped — no-sudo caffeinate holds from the evening before each print; API 0.0.0.0 LAN bind accepted and recorded as an owner decision; 602 tests green, lint clean)
