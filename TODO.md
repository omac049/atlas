...
- [ ] Loop 1, Search Console pulled nightly (`docs/GSC.md`): built 2026-09-11. Owner: create the personal-account service account, add it to both properties as Restricted. Then the Monday scoreboards come from `data/gsc/report.md`
